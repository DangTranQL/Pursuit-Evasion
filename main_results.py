...
def main(maze, pursuer, pursuer2, evader, q_learning,q_learning2, q_learning_avoid):
    # pursuer.reset()
    # pursuer2.reset()
    # evader.reset()
...
main(maze, pursuer, pursuer2, evader, q_learning,q_learning2, q_learning_avoid)
